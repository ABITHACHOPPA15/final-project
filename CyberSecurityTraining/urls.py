...
from CyberSecurityTraining import views as mainView
...
urlpatterns = [
    ...
    path("NISTTest/", usr.NISTTest, name="NISTTest"),
    path("ViewFiles/", usr.ViewFiles, name="ViewFiles"),
    path("download/", usr.download, name="download"),
    path('dataDecrypt/', usr.dataDecrypt, name='dataDecrypt'),
    path('reviewYourNIST/', usr.reviewYourNIST, name='reviewYourNIST'),
